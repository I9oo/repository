	...
	<div class="wrapper">
		...
		<div class="content-wrapper">
			...
			<div class="box box-primary">
				...
				<div class="box-body">
					...
					<div class="table-box">
							...
							<div class="form-group form-inline">
								<div class="btn-group">
									...
									<button type="button" class="btn btn-default" title="导出"
										onclick="javascript:location.href='/order/exportOrder'">
						...
						<table id="dataList"
							...
							<tbody>
							<c:forEach var="o" items="${pageInfo.list}" varStatus="vs">
								<tr>
				...
				<%--1.封装分页参数的表单(也可以有搜索条件)--%>
				<form name="frmPage" action="/order/findByPage" method="post">
					<%--当前页--%>
